# Sistema de Cofre de Moedas (Coin Vault)
...
1.  **Adicionar Moeda:** Permite adicionar moedas de diferentes tipos (Real, Dólar, Euro) e valores específicos.
2.  **Remover Moeda:** Lista as moedas existentes e permite remover uma específica pelo seu índice.
...
Certifique-se de estar na pasta raiz do projeto (`OBJECTORIENTEDPROGRAMMING`).

### Opção 1: Execução Direta (Java 22+)

Se você tiver o Java instalado, basta rodar o comando abaixo na raiz do projeto:
